    ...
    <div className="admin-shell">
      ...
      <aside className="admin-sidebar">
        ...
        <nav className="admin-nav">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <AdminNavLink href="/admin" exact><img src="/help/dashboard.png" alt="Dashboard" style={{ width: "100%", borderRadius: 6, display: "block" }} /></AdminNavLink>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <AdminNavLink href="/admin/routes"><img src="/help/routes.png" alt="Routes" style={{ width: "100%", borderRadius: 6, display: "block" }} /></AdminNavLink>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <AdminNavLink href="/admin/groepen"><img src="/help/groepen.png" alt="Groepen" style={{ width: "100%", borderRadius: 6, display: "block" }} /></AdminNavLink>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <AdminNavLink href="/admin/leaderboard"><img src="/help/leaderboard.png" alt="Leaderboard" style={{ width: "100%", borderRadius: 6, display: "block" }} /></AdminNavLink>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <AdminNavLink href="/admin/live"><img src="/help/live kaart.png" alt="Live kaart" style={{ width: "100%", borderRadius: 6, display: "block" }} /></AdminNavLink>
          <BroadcastKnop />
        </nav>
